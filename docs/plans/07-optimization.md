...
- **Skalierbarkeit der NetworkX-Lösung**: Bei sehr langen Routen (>1000 Segmente) oder vielen Ladestationen kann der Zustandsraum exponentiell wachsen → aktueller Prototyp ist für Reisen ≤800 km ausgelegt. Für größere Instanzen muss spätestens Phase 7c (OR-Tools) eingesetzt werden.
