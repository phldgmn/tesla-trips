...
_LAT_BAND_KM = 5.0
"""latitude der latitude-Baender für den raeumlichen Stations-Index (siehe
...
die pro query zu prüfende Kandidatenzahl massiv zu reduzieren - unabhaengig
...
def _stations_in_radius(
    ...
    latitude-Baendern, die `coordinate` innerhalb `radius_km` überhaupt
